...
def create_package(package_name, save_dir, package_dir):
    ...
    with open(os.path.join(save_dir, package_name, '__init__.py'), 'w',encoding='utf-8', newline='\n'):
        pass

    try: os.mkdir(save_dir + '/resource')
    except: pass
    with open(os.path.join(save_dir, 'resource', package_name), 'w', encoding='utf-8', newline='\n'):
        pass
